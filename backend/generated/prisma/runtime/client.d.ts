...
declare type LogLevel_2 =
  'trace' | 'debug' | 'info' | 'warn' | 'error' | 'query';
...
declare type QueryPlanNode =
  ImpureQueryPlanNode | PureQueryPlanNode<ImpureQueryPlanNode>;
...
export declare type ResultArgsFieldCompute = (
  model: any,
  modelName: string
) => unknown;
